...
function Contact() {
  return (
    <div>
        <div>
        <BreadCrumps title="Get in touch" page="Contact us" />
        {/* contact block */}
        {/* contact1 */}
