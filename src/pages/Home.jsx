          ...
          <div className="row">
              ...
              <div className="card">
                ...
                <div className="card-footer">
                  <div className="author align-items-center">
                    <img src="assets/images/a1.jpg" alt="true" className="img-fluid rounded-circle" />
            ...
            <div className="col-lg-4 col-md-6 item mt-md-0 mt-5">
              <div className="card">
                ...
                <div className="card-footer">
                  <div className="author align-items-center">
                    <img src="assets/images/a2.jpg" alt="true" className="img-fluid rounded-circle" />
                    <ul className="blog-meta">
                      <li>
            ...
            <div className="col-lg-4 col-md-6 item mt-lg-0 mt-5">
              <div className="card">
                ...
                <div className="card-footer">
                  <div className="author align-items-center">
                    <img src="assets/images/a4.jpg" alt="true" className="img-fluid rounded-circle" />
                    <ul className="blog-meta">
                      <li>
          ...
          <div className="col-md-6">
            <div className="top-pic1">
              <div className="card-body blog-details">
                ...
                <div className="author align-items-center">
                  <img src="assets/images/team1.jpg" alt="true" className="img-fluid rounded-circle" />
                  <ul className="blog-meta">
                    <li>
          ...
          <div className="col-md-6 mt-md-0 mt-4">
            <div className="top-pic2">
              <div className="card-body blog-details">
                ...
                <div className="author align-items-center">
                  <img src="assets/images/team2.jpg" alt="true" className="img-fluid rounded-circle" />
                  <ul className="blog-meta">
                    <li>
            ...
            <div className="mt-4">
              <div className="top-pic3">
                <div className="card-body blog-details">
                  ...
                  <div className="author align-items-center">
                    <img src="assets/images/team3.jpg" alt="true" className="img-fluid rounded-circle" />
                    <ul className="blog-meta">
                      <li>
            ...
            <div className="col-lg-7 feature-grid-right mt-lg-0 mt-5">
              <div className="row">
                <div className="col-sm-6">
                  <div className="box16">
                    <a href="#url"><img src="assets/images/team1.jpg" alt="true" className="img-fluid radius-image" /></a>
                ...
                <div className="col-sm-6 mt-sm-0 mt-3">
                  <div className="box16">
                    <a href="#url"><img src="assets/images/team2.jpg" alt="true" className="img-fluid radius-image" /></a>
                    <div className="box-content">
                ...
                <div className="col-sm-6 mt-lg-4 mt-3">
                  <div className="box16">
                    <a href="#url"><img src="assets/images/team3.jpg" alt="true" className="img-fluid radius-image" /></a>
                    <div className="box-content">
                ...
                <div className="col-sm-6 mt-lg-4 mt-3">
                  <div className="box16">
                    <a href="#url"><img src="assets/images/team4.jpg" alt="true" className="img-fluid radius-image" /></a>
                    <div className="box-content">
          ...
          <div className="company-logos text-center">
            <div className="row logos">
              <div className="col-lg-2 col-md-3 col-4">
                <img src="assets/images/brand1.png" alt="true" className="img-fluid" />
              </div>
              <div className="col-lg-2 col-md-3 col-4">
                <img src="assets/images/brand2.png" alt="true" className="img-fluid" />
              </div>
              <div className="col-lg-2 col-md-3 col-4">
                <img src="assets/images/brand3.png" alt="true" className="img-fluid" />
              </div>
              <div className="col-lg-2 col-md-3 col-4 mt-md-0 mt-4">
                <img src="assets/images/brand4.png" alt="true" className="img-fluid" />
              </div>
              <div className="col-lg-2 col-md-3 col-4 mt-lg-0 mt-4">
                <img src="assets/images/brand5.png" alt="true" className="img-fluid" />
              </div>
              <div className="col-lg-2 col-md-3 col-4 mt-lg-0 mt-4">
                <img src="assets/images/brand6.png" alt="true" className="img-fluid" />
              </div>
            </div>
          </div>
        </div>
