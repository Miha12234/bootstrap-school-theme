    ...
    <section className="w3l-footer-29-main">
        ...
        <div className="container py-md-4">
          <div className="row footer-top-29">
            ...
            <div className="col-lg-3 col-md-6 col-sm-7 footer-list-29 footer-4 mt-lg-0 mt-5">
              ...
              <a href="#playstore"><img src="assets/images/googleplay.png" className="img-responsive" alt="true" /></a>
              <a href="#appstore"><img src="assets/images/appstore.png" className="img-responsive mt-3" alt="true" /></a>
            </div>
          </div>
        </div>
      </div>
      ...
      <section className="w3l-copyright text-center">
        <div className="container">
          <p className="copy-footer-29">© 2020 Study Course. All rights reserved. Design by <a href="https://w3layouts.com/" target="_blank" rel="noreferrer">
              W3Layouts</a></p>
        </div>
        {/* move top */}
