      ...
      <a class="navbar-brand" href="#index.html">
          ...
          <div className="collapse navbar-collapse" id="navbarTogglerDemo02">
              ...
              <div id="search" className="pop-overlay">
                <div className="popup">
                  <form action="error.html" method="GET" className="search-box">
                    ...
                    <button type="submit" className="btn"><span className="fa fa-search" aria-hidden="true" /></button>
                  </form>
                </div>
            ...
            <div className="top-quote mr-lg-2 text-center">
              <a href="#login" className="btn login mr-2"><span className="fa fa-user" /> login</a>
            </div>
          </div>
